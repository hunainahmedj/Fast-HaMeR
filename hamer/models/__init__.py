...
from .efficient_hamer import EfficientHAMER
...
def load_hamer(checkpoint_path=DEFAULT_CHECKPOINT, init_renderer: bool = True):
    ...
    model = HAMER.load_from_checkpoint(checkpoint_path, strict=False, cfg=model_cfg, init_renderer=init_renderer)
...
def load_efficient_hamer(checkpoint_path=DEFAULT_CHECKPOINT):
    ...
    model = EfficientHAMER.load_from_checkpoint(
